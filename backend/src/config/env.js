...
const defaultCorsOrigins = isProduction
  ? 'https://timelogic-superadmin.pages.dev,https://timelogic.pages.dev,https://timelogic-app.pages.dev,https://timelogic-fill-form.pages.dev,https://timelogic-admin.pages.dev'
